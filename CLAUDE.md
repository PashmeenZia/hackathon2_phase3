...
- Python 3.11+ (backend), TypeScript 5.0+ (frontend) + FastAPI 0.104+, OpenAI SDK 1.12+, MCP SDK 0.9+, SQLModel 0.0.16+, Next.js 14+, React 18+ (004-ai-todo-chatbot)
- Neon Serverless PostgreSQL (conversation history, tasks, messages) (004-ai-todo-chatbot)
